...
val LocalExtendedColors = staticCompositionLocalOf<ExtendedColorScheme> { error("No extended colors provided") }
...
fun StashGuardTheme(
    ...
    SetSystemBarsContentColor(darkTheme)
...
fun SetSystemBarsContentColor(
    ...
    if (!view.isInEditMode) {
        SideEffect {
            ...
            windowInsetsControllerCompat.isAppearanceLightStatusBars = darkTheme.not()
            windowInsetsControllerCompat.isAppearanceLightNavigationBars = darkTheme.not()
        }
    }
}